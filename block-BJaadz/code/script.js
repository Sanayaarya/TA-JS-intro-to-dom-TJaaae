...
let allHrsArray = Array.from(allHr);
...
imageClass.style.border = "2px solid blue";
...
document.querySelector(".two").prepend("Prepend inserts as last child");
...
let oddOne = document.querySelectorAll(".box")
 
let oddOneArray = Array.from(oddOne)

oddOneArray.forEach((ele,index)=>{
  if(index % 2 === 0){
    return ele.style.backgroundColor = "aliceblue";
  }
  else {
...
document.querySelector(".four").remove("awesome-box");
